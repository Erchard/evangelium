...
Run `python3 tools/qa_crosscheck.py` before and after each major editorial pass. Full appendix editorial consolidation is complete; next close the wealth/renunciation cluster-control group and move toward the evidence dossier publication pass.
