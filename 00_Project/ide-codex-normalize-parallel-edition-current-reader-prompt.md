...
Приведи `06_Reconstructions/earliest-sayings-gospel/parallel-edition.md` до охайного робочого формату, який відповідає поточному чистому українському reader text і ясно розділяє:
