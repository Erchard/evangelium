...
- `04_Synoptic_Parallels/logion-020-mustard-seed.md` як модель детальної таблиці
- `04_Synoptic_Parallels/logion-010-fire-luke-control.md` як модель коротшого контрольного файлу
- `02_Sources_And_Manuscripts/primary_texts/coptic/linssen-thomas-coptic-unicode-working.txt`
...
- `02_Sources_And_Manuscripts/primary_texts/coptic/logia-063-065-coptic-extraction.md`
...
- онови `06_Reconstructions/earliest-sayings-gospel/inclusion-decisions-table.md`;
...
- Не змінюй `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk.md` у цьому спринті.
