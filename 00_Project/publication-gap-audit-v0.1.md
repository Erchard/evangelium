...
| Full 114-logion appendix | Є для всіх 114 як каркас; 23 включені логії/ядра вже розгорнуті |
...
Файл `06_Reconstructions/earliest-sayings-gospel/full-logion-commentary-appendix-uk.md` уже дуже корисний, але це ще не фінальний коментар.

Він має каркас для всіх 114 логій. Розгорнуті читацькі секції вже створено для 23 включених логій/ядер:
...
Проект правильно маркує `Greek retroversion, hypothetical`, і створено `06_Reconstructions/earliest-sayings-gospel/greek-retroversion-confidence-audit-v0.1.md`. Перед публікацією ще потрібно:
...
1. Continue full appendix expansion for included 31 logia/cores; next packet: 34, 35, 36, 39, 41.
