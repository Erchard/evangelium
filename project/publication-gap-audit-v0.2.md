...
| Full 114-logion appendix | Є для всіх 114; усі секції мають читацьке пояснення; Logia 1-80 editorially consolidated, Logia 81-114 pending consolidation |
...
Він має 114/114 секцій із читацьким поясненням. Logia 1-80 уже редакційно консолідовані в цілісний коментар без окремих card-derived blocks. Logia 81-114 ще потребують такого самого проходу, тепер уже за print-safe rule: у прозі для читача не покладатися на клікабельні repo links.
...
1. Print-safe full appendix editorial consolidation, continuing with Logia 81-90.
2. Image/preexistence/Adam/deathlessness technical control pass.
3. Body-soul anthropology technical control pass.
4. Logion 114 publication-level exclusion rationale.
5. Evidence dossier publication pass.
6. Greek retroversion publication polish against academic editions.
7. Bibliography, rights, indexes, and final print/digital generation pass.
