...
1. Wealth/renunciation cluster-control.
...
The most valuable immediate work is now wealth/renunciation cluster-control. Reviews A/B, the controlled clean-reader candidate pass, all-114 publication decision table, evidence-rationale packages, reader-interpretation sync, print/digital architecture, and full appendix consolidation have stabilized the reader-facing layer; the project now needs remaining research-control closure before clean-reader freeze and evidence dossier publication pass.
