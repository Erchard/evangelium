...
Проект ще не 100%, бо digital companion уже має Markdown/TSV/PDF і browsable HTML proof, production gate уже обрав Typst/professional handoff як фінальний шлях, а Typst-ready handoff package уже створено; проте Typst pilot ще не скомпільовано у Typst-capable середовищі, фінальна human copyedit-перевірка української й англійської книг ще попереду.
...
| Production gate | Виконано: ReportLab = proof-only; Typst/professional handoff = final production path |
| Typst production pilot | Виконано як handoff package; compilation pending external Typst/professional environment |
| Open-task prompt queue | Є: `project/open-task-prompt-queue-2026-07-18.md`; поточний `NEXT` - external production compile and human copyedit signoff |
...
9. Bibliography / rights / citation policy тепер має release verification layer v0.2; print/digital render proof preparation, перші HTML/PDF proofs, перший Bible-style layout correction pass, Bible-style book design/index pass, final proof polish, release-candidate proof audit, full book assembly, full Ukrainian proof QA, English appendix structural generation, English appendix editorial quality pass, full English proof QA, digital companion expansion, browsable companion HTML, final production/copyedit gate, Typst production handoff package і release-candidate audit виконано; перед 100% лишаються external Typst/professional compile, фінальна human copyedit і release signoff.
...
Найважливіша наступна дія: external production compile and human copyedit signoff. Greek-layer freeze, Greek retroversion publication polish, final clean-reader freeze, generator-ready book source packages, final bibliography / rights verify, print/digital render proof preparation, render pipeline / first proofs, first proof QA/layout corrections, Bible-style book design/index pass, final proof polish, release-candidate proof audit, full book assembly, full Ukrainian proof QA, English full appendix structural generation, English appendix editorial quality pass, full English proof QA, digital companion expansion, browsable companion HTML, final production/copyedit gate, Typst production handoff package і release-candidate audit v1.0-rc1 виконано. Тепер корпус і виходи існують, production path обрано, handoff package підготовлено; треба виконати зовнішню production-компіляцію, людську редактуру й фінальний signoff.
