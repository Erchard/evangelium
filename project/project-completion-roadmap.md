...
| Повний додаток до 114 логій | Є як каркас для всіх 114; 28 включених логій/ядер розгорнуті |
...
Причина: Greek retroversion confidence audit уже створено. Тепер головний читацький ризик - що чистий текст випереджає повний український додаток. Треба перетворити включені логії з каркасних секцій на повноцінні коментарі з джерелами, паралелями, тлумаченнями й причиною включення.
