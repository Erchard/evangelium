...
- relevant cards in `corpus/cards/`
- relevant evidence notes in `reconstruction/earliest-sayings-gospel/notes/`

Use local sources first:

- Coptic: `sources/primary_texts/coptic/linssen-thomas-coptic-unicode-working.txt`
- Greek P.Oxy.: `sources/primary_texts/greek_poxy/`
