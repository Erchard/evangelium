...
- Coptic source: `sources/primary_texts/coptic/linssen-thomas-coptic-unicode-working.txt`
- Greek P.Oxy. files: `sources/primary_texts/greek_poxy/`
- source register: `sources/primary_texts/source-register.md`
