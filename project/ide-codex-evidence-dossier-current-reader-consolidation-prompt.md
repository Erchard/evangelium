...
The file `reconstruction/earliest-sayings-gospel/evidence-dossier-en.md` already contains a methodology and summary blocks for many of these logia, but it is not yet synchronized with the latest current reader set. In particular, Logia 41, 54, 72, and 73 must be integrated into the dossier.

## Task

Update `reconstruction/earliest-sayings-gospel/evidence-dossier-en.md` so that it supports the current 24-logion reader text.
...
7. Update `sources/primary_texts/collection-log.md` with a short dated note describing the work.
