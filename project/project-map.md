...
| Завершення | `project/open-task-prompt-queue-2026-07-18.md` | Активна черга високоякісних промптів для незакритих задач; актуальний `NEXT` - final production typesetting and copyedit gate. |
...
| Завершення | `project/full-book-assembly-typesetting-pipeline-v0.1.md` | Audit full-book assembly pass: 118-page Ukrainian full proof, 61-page English proof package, 5-page digital source-map proof. |
...
| Робочий промпт | `project/ide-codex-final-production-typesetting-copyedit-gate-v0.1-prompt.md` | Поточний NEXT-промпт: визначити final production path і провести фінальний copyedit/proof gate. |
