...
Source: NHC II,2 as represented in `02_Sources_And_Manuscripts/primary_texts/coptic/logia-001-007-coptic-working.md`.
...
Reconstruction note: the proposed early core is the kingdom-not-as-place statement; the self-knowledge continuation remains marked.
...
Reconstruction note: the first/last saying is the proposed early core; the surrounding image remains marked.
...
Reconstruction note: the hidden/revealed maxim is the proposed early core; the "before your face" command remains marked.
...
Reconstruction note: only the short ethical core "do not lie / do not do what you hate" is used in the clean reader. The ritual-practice question and hidden/revealed ending remain apparatus material.

## Logion 9

Decision: short sower core `INCLUDE_WITH_MARKER`; full logion `UNCERTAIN`
...
Reconstruction note: the clean reader uses the four-soil parable core and omits distinctive full-form details such as worm, upward fruit, and numeric yield.
...
Reconstruction note: only the short fire-casting core is used in the clean reader; the watching/until-blazing continuation remains apparatus material.
...
Reconstruction note: the clean reader uses only the division/household core. Fire/sword/war and the monachos ending remain apparatus material.
...
Reconstruction note: the short mustard-seed parable is used in the clean reader.
...
Reconstruction note: only the children/kingdom core is used in the clean reader; the unity-of-opposites expansion remains apparatus material.
...
Reconstruction note: both prophet and physician clauses are printed in the clean reader, with the physician clause remaining less secure in the apparatus.
...
Reconstruction note: the clean reader prints both the ear/rooftop unit and the lamp unit. The full Thomas form is composite and remains marked in the apparatus.
...
Reconstruction note: the clean reader follows the short Coptic clothing-focused form. P.Oxy. 655 and synoptic controls preserve a broader related complex.
...
Reconstruction note: the clean reader prints this as two units: keys of knowledge / blocked entry, and wise serpents / pure doves. The transmitted form is composite.
...
> [ⲡⲉϫⲉ ⲟⲩⲣⲱⲙⲉ ⲛⲁϥ`] ϫⲉ ϫⲟⲟⲥ ⲛ̅ⲛⲁⲥⲛⲏⲩ ϣⲓⲛⲁ ⲉⲩⲛ[ⲁⲡ]ⲱϣⲉ ⲛ̅ⲛ̅ϩⲛⲁⲁⲩ ⲙ̅ⲡⲁⲉⲓⲱⲧ` ⲛⲙ̅ⲙⲁⲉⲓ ⲡⲉϫⲁϥ ⲛⲁϥ` ϫⲉ ⲱ ⲡⲣⲱⲙⲉ ⲛⲓⲙ ⲡⲉ ⲛ̅ⲧⲁϩⲁⲁⲧ` ⲛ̅ⲣⲉϥⲡⲱϣⲉ ⲁϥⲕⲟⲧϥ̅ ⲁ`ⲛⲉϥⲙⲁⲑⲏⲧⲏⲥ ⲡⲉϫⲁϥ ⲛⲁⲩ ϫⲉ ⲙⲏ ⲉⲉⲓϣⲟⲟⲡ` ⲛ̅ⲣⲉϥ`ⲡⲱϣⲉ

Reconstruction note: the inheritance-dispute refusal is included with marker; the opening has bracketed/restored material and the main external control is Luke 12:13-14.
