...
- Нормалізовано `06_Reconstructions/earliest-sayings-gospel/parallel-edition.md` до робочого формату v0.4.
...
- Збережено і виконано промпт: `00_Project/ide-codex-multilingual-sync-current-reader-remainder-prompt.md`.
- Синхронізовано Logia 6, 9, 10, 16, 20, 22, 25, 26, 31, 32, 33, 34, 35, 36, 39 з англійським reader layer: `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-en.md`.
- Додано повні коптські base-witness sections для цих логій у `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-coptic.md`.
- Додано extant/partial/lacunose Greek witness або clearly marked `Greek retroversion, hypothetical` для цих логій у `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-greek.md`.
- Додано компактні рядки до `06_Reconstructions/earliest-sayings-gospel/parallel-edition.md`.
- Оновлено `05_Logia_Corpus/tables/logia-workflow-matrix.md`: ці логії позначено як `Multilingual sync v0.1`.
...
- Збережено і виконано промпт: `00_Project/ide-codex-multilingual-sync-041-054-072-073-prompt.md`.
- Оновлено англійський reader layer: `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-en.md`.
- Оновлено коптський base witness layer: `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-coptic.md`.
- Оновлено грецький layer: `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-greek.md`; для Logia 41, 54, 72, 73 додано тільки `Greek retroversion, hypothetical`, не extant Greek witness.
- Оновлено `06_Reconstructions/earliest-sayings-gospel/parallel-edition.md`: додано рядки для Logia 41, 54, 72, 73.
- Оновлено `05_Logia_Corpus/tables/logia-workflow-matrix.md`: Logia 41, 54, 72, 73 позначено як `Multilingual sync v0.1`.
...
- Збережено і виконано промпт: `00_Project/ide-codex-clean-reader-pass-041-054-072-073-prompt.md`.
- Оновлено чистий український reader: `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk.md`.
- До чистого reader text додано Logia 41, 54, 72, 73 без статусів, квадратних дужок, маркерів і коментарів.
- Оновлено український апарат: `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk-apparatus.md`.
- Оновлено читацький коментар: `06_Reconstructions/earliest-sayings-gospel/reader-commentary-uk.md`.
- Оновлено `05_Logia_Corpus/tables/logia-workflow-matrix.md`: Logia 41, 54, 72, 73 позначено як `Reader pass v0.1`.
...
- Збережено і виконано промпт: `00_Project/ide-codex-synoptic-control-and-coptic-extraction-prompt.md`.
- Створено synoptic control files для Logia 41, 54, 72, 73: `04_Synoptic_Parallels/logion-041-has-given-controls.md`, `04_Synoptic_Parallels/logion-054-blessed-poor-controls.md`, `04_Synoptic_Parallels/logion-072-inheritance-dispute-controls.md`, `04_Synoptic_Parallels/logion-073-harvest-workers-controls.md`.
- Створено повний коптський extraction file для Logia 63-65: `02_Sources_And_Manuscripts/primary_texts/coptic/logia-063-065-coptic-extraction.md`.
- Оновлено `06_Reconstructions/earliest-sayings-gospel/inclusion-decisions-table.md`: Logia 41, 54, 72, 73 переведено до `INCLUDE_WITH_MARKER`; Logia 63-65 отримали посилання на повний коптський extraction.
- Оновлено `05_Logia_Corpus/tables/logia-workflow-matrix.md`: для Logia 41, 54, 72, 73 позначено synoptic controls; для Logia 63-65 зафіксовано Coptic extraction v0.1.
...
- Збережено і виконано промпт: `00_Project/ide-codex-evidence-sprint-high-priority-01-prompt.md`.
...
- Оновлено `05_Logia_Corpus/tables/logia-workflow-matrix.md`: для цих логій evidence note позначено як `YES`.
- Оновлено `06_Reconstructions/earliest-sayings-gospel/inclusion-decisions-table.md` робочими рішеннями.
...
- Збережено і виконано промпт: `00_Project/ide-codex-full-corpus-classification-prompt.md`.
- Створено документ `06_Reconstructions/earliest-sayings-gospel/full-corpus-classification-v0.1.md`.
...
- Залишкові `NOT_DECIDED` у `05_Logia_Corpus/tables/logia-workflow-matrix.md` замінено на робочі рішення.
- Синхронізовано ранні неповні статуси в `05_Logia_Corpus/tables/logia-index.md`.
...
- Збережено і виконано промпт: `00_Project/ide-codex-corpus-sprint-101-114-quality-prompt.md`.
- Створено первинні картки `05_Logia_Corpus/cards/logion-101.md` - `05_Logia_Corpus/cards/logion-114.md`.
- Логію 104 перетворено з контрольної картки на повну первинну корпусну картку.
- Оновлено `05_Logia_Corpus/tables/logia-workflow-matrix.md`: у матриці більше немає логій зі статусом `NOT_STARTED`.
- Оновлено `05_Logia_Corpus/tables/logia-index.md`: додано записи 101-114 з попередніми шарами, рішеннями й імовірнісними оцінками.
...
- Виконано збережений промпт: `00_Project/ide-codex-corpus-sprint-081-100-quality-prompt.md`.
- Створено первинні картки `05_Logia_Corpus/cards/logion-081.md` - `05_Logia_Corpus/cards/logion-100.md`.
- Оновлено `05_Logia_Corpus/tables/logia-workflow-matrix.md`: логії 81-100 більше не мають статусу `NOT_STARTED`.
- Оновлено `05_Logia_Corpus/tables/logia-index.md` попередніми шарами, рішеннями й імовірнісними оцінками для 81-100.
...
- Збережено якісний робочий промпт: `00_Project/ide-codex-corpus-sprint-081-100-quality-prompt.md`.
...
- Оновлено `00_Project/project-map.md`.

## 2026-07-17, очищення українського читацького тексту

- Оновлено `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk.md`: прибрано вступний статус, дисклеймери, квадратні дужки й редакційні ярлики.
...
- Створено окремий концептуальний документ `00_Project/clean-reader-text-first-page-principle.md`.
...
- Оновлено `00_Project/clean-text-plus-commentary-concept.md`, `00_Project/final-product-specification.md`, `00_Project/ide-codex-master-project-prompt.md`, `00_Project/project-map.md` і `06_Reconstructions/earliest-sayings-gospel/README.md`.

## 2026-07-17, корпусний спринт 61-80: первинні картки

- Виконано збережений промпт: `00_Project/ide-codex-corpus-sprint-061-080-quality-prompt.md`.
- Створено первинні картки `05_Logia_Corpus/cards/logion-061.md` - `05_Logia_Corpus/cards/logion-080.md`.
- Оновлено `05_Logia_Corpus/tables/logia-workflow-matrix.md`: логії 61-80 більше не мають статусу `NOT_STARTED`.
- Оновлено `05_Logia_Corpus/tables/logia-index.md` попередніми шарами, рішеннями й імовірнісними оцінками для 61-80.
...
- Збережено промпт: `00_Project/ide-codex-reader-commentary-first-pass-prompt.md`.
- Виконано перший повний коментарний прохід для всіх одиниць, уже включених у `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk.md`.
- Оновлено `06_Reconstructions/earliest-sayings-gospel/reader-commentary-uk.md`: замість шаблону створено розділи для логій 1, 2, 3, 4, 5, 6 ethical core, 9 core, 10 core, 16 core, 20, 22 core, 25, 26, 31, 32, 33, 34, 35, 36, 39.
...
- Створено окремий концептуальний документ `00_Project/clean-text-plus-commentary-concept.md`.
- Оновлено `00_Project/final-product-specification.md`.
- Оновлено `00_Project/ide-codex-master-project-prompt.md`.
- Оновлено `00_Project/project-completion-roadmap.md`.
- Оновлено `00_Project/project-map.md`.
- Створено робочий файл `06_Reconstructions/earliest-sayings-gospel/reader-commentary-uk.md`.
...
- Виконано збережений промпт: `00_Project/ide-codex-corpus-sprint-040-060-quality-prompt.md`.
- Створено первинні картки `05_Logia_Corpus/cards/logion-040.md` - `05_Logia_Corpus/cards/logion-060.md`.
- Оновлено операційну матрицю `05_Logia_Corpus/tables/logia-workflow-matrix.md`: логії 40-60 більше не мають статусу `NOT_STARTED`.
- Оновлено індекс `05_Logia_Corpus/tables/logia-index.md` попередніми шарами, ймовірностями й рішеннями для 40-60.
...
- Збережено промпт: `00_Project/ide-codex-logion-011-composite-split-prompt.md`.
- Створено синоптичну таблицю: `04_Synoptic_Parallels/logion-011-heaven-passing-controls.md`.
- Створено evidence note: `06_Reconstructions/earliest-sayings-gospel/notes/logion-011-evidence-en.md`.
...
- Збережено промпт: `00_Project/ide-codex-logion-010-fire-core-deepening-prompt.md`.
- Створено синоптичну таблицю: `04_Synoptic_Parallels/logion-010-fire-luke-control.md`.
- Створено evidence note: `06_Reconstructions/earliest-sayings-gospel/notes/logion-010-evidence-en.md`.
...
- Збережено промпт: `00_Project/ide-codex-logion-009-sower-core-finalization-prompt.md`.
- Створено фінальну контрольну таблицю: `04_Synoptic_Parallels/logion-009-sower-core-final-controls.md`.
...
- Створено `04_Synoptic_Parallels/logion-009-sower.md`.
- Створено `06_Reconstructions/earliest-sayings-gospel/notes/logion-009-evidence-en.md`.
- Оновлено `05_Logia_Corpus/cards/logion-009.md` до поглибленої картки v0.2.
- Оновлено `05_Logia_Corpus/tables/logia-index.md`.
- Оновлено `05_Logia_Corpus/tables/logia-workflow-matrix.md`.
- Оновлено `06_Reconstructions/earliest-sayings-gospel/inclusion-decisions-table.md`.
- Оновлено `06_Reconstructions/earliest-sayings-gospel/evidence-dossier-en.md`.
...
- Збережено магістральний промпт `00_Project/ide-codex-project-completion-pipeline-prompt.md`.
- Створено `00_Project/project-completion-roadmap.md` з фазами завершення, критеріями готовності логії й пакетами роботи.
- Створено `05_Logia_Corpus/tables/logia-workflow-matrix.md` - повну операційну матрицю для 114 логій.
- Створено `00_Project/next-sprint-logia-008-013-prompt.md` як наступний виконуваний пакет.
- Оновлено `00_Project/project-map.md`.
...
- Створено `05_Logia_Corpus/cards/logion-008.md`.
- Створено `05_Logia_Corpus/cards/logion-009.md`.
- Створено `05_Logia_Corpus/cards/logion-010.md`.
- Створено `05_Logia_Corpus/cards/logion-011.md`.
- Створено `05_Logia_Corpus/cards/logion-012.md`.
- Створено `05_Logia_Corpus/cards/logion-013.md`.
- Оновлено `05_Logia_Corpus/tables/logia-index.md`.
- Оновлено `05_Logia_Corpus/tables/logia-workflow-matrix.md`.
...
- Збережено промпт `00_Project/ide-codex-uk-reader-v03-prompt.md`.
- Оновлено `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk.md` до чистішої читацької версії v0.3.
- Створено `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk-apparatus.md` з коротким українським поясненням маркерів, ядра й можливих розгортань.
- Оновлено `06_Reconstructions/earliest-sayings-gospel/README.md`.
...
- Створено `04_Synoptic_Parallels/logion-006-matthew-6-ritual-practice.md`.
- Створено контрольні картки `05_Logia_Corpus/cards/logion-014.md`, `logion-027.md`, `logion-104.md`.
- Створено англомовну кластерну нотатку `06_Reconstructions/earliest-sayings-gospel/notes/ritual-ethics-cluster-006-014-027-104-en.md`.
...
- Створено `04_Synoptic_Parallels/logion-003-luke-17-kingdom.md`.
- Створено `04_Synoptic_Parallels/logion-004-first-last.md`.
- Створено `04_Synoptic_Parallels/logion-005-hidden-revealed.md`.
...
- Створено англомовні evidence notes для логій 1 і 3-7 у `06_Reconstructions/earliest-sayings-gospel/notes/`.
...
- `05_Logia_Corpus/cards/logion-002.md` - перша пілотна картка логії.
...
- `02_Sources_And_Manuscripts/primary_texts/translations/logia-001-007-control-translations.md` - контрольні нотатки за відкритим public domain перекладом Mark M. Mattison / Gospels.net і таблиці паралелей для логій 1-7.
- `05_Logia_Corpus/cards/logion-001.md` - пілотна картка логії 1.
- `05_Logia_Corpus/cards/logion-003.md` - пілотна картка логії 3.
- `05_Logia_Corpus/cards/logion-004.md` - пілотна картка логії 4.
- `05_Logia_Corpus/cards/logion-005.md` - пілотна картка логії 5.
- `05_Logia_Corpus/cards/logion-006.md` - пілотна картка логії 6.
- `05_Logia_Corpus/cards/logion-007.md` - пілотна картка логії 7.
- `05_Logia_Corpus/tables/logia-index.md` оновлено для логій 1-7.
...
- `00_Project/ide-codex-logion-002-deepening-prompt.md` - промпт для поглиблення логії 2 як першого еталону методу.
- `04_Synoptic_Parallels/logion-002-matthew-luke.md` - окреме зіставлення Фоми 2 з Мт 7:7 і Лк 11:9.
- `05_Logia_Corpus/cards/logion-002.md` оновлено до еталонної аналітичної картки v0.1.
- `05_Logia_Corpus/tables/logia-index.md` оновлено першою робочою оцінкою для логії 2.
...
- `00_Project/ide-codex-logion-002-gold-standard-prompt.md` - промпт для доведення логії 2 до відкрито перевіреного стандарту.
- `02_Sources_And_Manuscripts/primary_texts/notes/logion-002-source-verification.md` - audit trail джерельної перевірки логії 2.
- `01_Methodology/logion-rating-rubric.md` - рубрика оцінювання окремої логії.
- `02_Sources_And_Manuscripts/primary_texts/coptic/facsimiles/grondin-nhc2p32-scan0001.jpg` - факсиміле NHC II p.32.
- `02_Sources_And_Manuscripts/primary_texts/coptic/facsimiles/grondin-nhc2p32-color.jpg` - кольоровий контрольний знімок сторінки 32.
- `02_Sources_And_Manuscripts/primary_texts/coptic/facsimiles/grondin-nhc2-display-32-33.jpg` - display leaf сторінок 32-33.
- `04_Synoptic_Parallels/logion-002-matthew-luke.md` оновлено точними формами Мт 7:7 і Лк 11:9 за SBLGNT.
- `05_Logia_Corpus/cards/logion-002.md` оновлено до відкрито перевіреної еталонної картки v0.2.
...
- `00_Project/ide-codex-build-first-reconstruction-sample-prompt.md` - промпт для створення першого зразка фінальної реконструкції.
- `06_Reconstructions/earliest-sayings-gospel/README.md` - опис папки майбутньої реконструкції.
- `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk.md` - український читацький шар, наразі з логією 2.
- `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-coptic.md` - коптський базовий шар.
- `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-greek.md` - грецький засвідчений шар.
- `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-en.md` - англійський читацький шар.
- `06_Reconstructions/earliest-sayings-gospel/parallel-edition.md` - перший паралельний рядок для логії 2.
- `06_Reconstructions/earliest-sayings-gospel/inclusion-decisions-table.md` - перше рішення `INCLUDE_WITH_MARKER`.
- `06_Reconstructions/earliest-sayings-gospel/evidence-dossier-en.md` - початковий англомовний доказовий корпус.
- `06_Reconstructions/earliest-sayings-gospel/notes/logion-002-evidence-en.md` - детальна англомовна evidence note для логії 2.
...
- `05_Logia_Corpus/cards/logion-015.md` - первинна картка логії 15.
- `05_Logia_Corpus/cards/logion-016.md` - первинна картка логії 16.
- `05_Logia_Corpus/cards/logion-017.md` - первинна картка логії 17.
- `05_Logia_Corpus/cards/logion-018.md` - первинна картка логії 18.
- `05_Logia_Corpus/cards/logion-019.md` - первинна картка логії 19.
- `05_Logia_Corpus/cards/logion-020.md` - первинна картка логії 20.
- `05_Logia_Corpus/cards/logion-021.md` - первинна картка логії 21.
- `05_Logia_Corpus/cards/logion-022.md` - первинна картка логії 22.
- `05_Logia_Corpus/cards/logion-023.md` - первинна картка логії 23.
- `05_Logia_Corpus/cards/logion-024.md` - первинна картка логії 24 з окремою перевіркою P.Oxy. 655.
- `05_Logia_Corpus/cards/logion-025.md` - первинна картка логії 25.
- `05_Logia_Corpus/tables/logia-index.md` оновлено для логій 15-25.
- `05_Logia_Corpus/tables/logia-workflow-matrix.md` оновлено для логій 15-25.
...
- `00_Project/ide-codex-logion-020-mustard-seed-deepening-prompt.md` - промпт для поглиблення логії 20.
- `04_Synoptic_Parallels/logion-020-mustard-seed.md` - синоптична evidence table для Thomas 20 / Mark 4:30-32 / Matthew 13:31-32 / Luke 13:18-19.
- `06_Reconstructions/earliest-sayings-gospel/notes/logion-020-evidence-en.md` - англомовна evidence note для логії 20.
- `05_Logia_Corpus/cards/logion-020.md` оновлено до поглибленої картки v0.2.
- `05_Logia_Corpus/tables/logia-index.md` оновлено probability assessment для логії 20.
- `05_Logia_Corpus/tables/logia-workflow-matrix.md` оновлено статус логії 20.
- `06_Reconstructions/earliest-sayings-gospel/inclusion-decisions-table.md` додано рішення для логії 20.
- `06_Reconstructions/earliest-sayings-gospel/evidence-dossier-en.md` додано короткий summary логії 20.
...
- `00_Project/ide-codex-logion-020-branch-tree-commentary-check-prompt.md` - промпт для точкової перевірки логії 20.
- `06_Reconstructions/earliest-sayings-gospel/notes/logion-020-branch-tree-commentary-check-en.md` - англомовна нотатка щодо варіації `branch / tree`.

### Що оновлено

- `05_Logia_Corpus/cards/logion-020.md` оновлено до v0.3.
- `04_Synoptic_Parallels/logion-020-mustard-seed.md` доповнено висновком після перевірки.
- `06_Reconstructions/earliest-sayings-gospel/notes/logion-020-evidence-en.md` оновлено до v0.2.
- `05_Logia_Corpus/tables/logia-index.md`, `05_Logia_Corpus/tables/logia-workflow-matrix.md`, `06_Reconstructions/earliest-sayings-gospel/inclusion-decisions-table.md` і `06_Reconstructions/earliest-sayings-gospel/evidence-dossier-en.md` синхронізовано.
...
- `00_Project/ide-codex-logion-022-children-kingdom-deepening-prompt.md` - промпт для поглиблення логії 22.
- `04_Synoptic_Parallels/logion-022-children-kingdom.md` - синоптична evidence table для Thomas 22 / Mark 10 / Matthew 18-19 / Luke 18.
- `06_Reconstructions/earliest-sayings-gospel/notes/logion-022-evidence-en.md` - англомовна evidence note для логії 22.

### Що оновлено

- `05_Logia_Corpus/cards/logion-022.md` оновлено до v0.2.
- `05_Logia_Corpus/tables/logia-index.md` додано probability assessment для логії 22.
- `05_Logia_Corpus/tables/logia-workflow-matrix.md` оновлено статус логії 22.
- `06_Reconstructions/earliest-sayings-gospel/inclusion-decisions-table.md` додано рішення для логії 22.
- `06_Reconstructions/earliest-sayings-gospel/evidence-dossier-en.md` додано summary логії 22.
...
- `00_Project/ide-codex-thomas-unity-monachos-cluster-prompt.md` - промпт для перевірки unity / monachos cluster.
- `06_Reconstructions/earliest-sayings-gospel/notes/thomas-unity-monachos-cluster-en.md` - англомовна кластерна evidence note.

### Що оновлено

- `05_Logia_Corpus/cards/logion-022.md` доповнено посиланням на кластерну перевірку.
- `05_Logia_Corpus/cards/logion-023.md` оновлено до v0.2 і переведено в `UNCERTAIN`.
- `05_Logia_Corpus/tables/logia-index.md` додано probability assessment для логії 23.
- `05_Logia_Corpus/tables/logia-workflow-matrix.md` синхронізовано для логій 22 і 23.
- `06_Reconstructions/earliest-sayings-gospel/inclusion-decisions-table.md` додано рішення для логії 23.
- `06_Reconstructions/earliest-sayings-gospel/evidence-dossier-en.md` додано cluster summary.
...
- `00_Project/ide-codex-logion-016-division-monachos-deepening-prompt.md` - промпт для поглиблення логії 16.
- `04_Synoptic_Parallels/logion-016-division-family.md` - синоптична evidence table для Thomas 16 / Matthew 10:34-36 / Luke 12:49-53.
- `06_Reconstructions/earliest-sayings-gospel/notes/logion-016-evidence-en.md` - англомовна evidence note для логії 16.

### Що оновлено

- `05_Logia_Corpus/cards/logion-016.md` оновлено до v0.2.
- `05_Logia_Corpus/tables/logia-index.md` додано probability assessment для логії 16.
- `05_Logia_Corpus/tables/logia-workflow-matrix.md` оновлено статус логії 16.
- `06_Reconstructions/earliest-sayings-gospel/inclusion-decisions-table.md` додано рішення для логії 16.
- `06_Reconstructions/earliest-sayings-gospel/evidence-dossier-en.md` додано summary логії 16.
...
- `00_Project/ide-codex-logion-025-love-brother-deepening-prompt.md` - промпт для поглиблення логії 25.
- `04_Synoptic_Parallels/logion-025-love-brother.md` - evidence table для Thomas 25 / Lev 19:18 / Mark 12:31 / Matthew 22:39 / Luke 10:27 / біблійного образу зіниці ока.
- `06_Reconstructions/earliest-sayings-gospel/notes/logion-025-evidence-en.md` - англомовна evidence note для логії 25.

### Що оновлено

- `05_Logia_Corpus/cards/logion-025.md` оновлено до v0.2.
- `05_Logia_Corpus/tables/logia-index.md` додано probability assessment для логії 25.
- `05_Logia_Corpus/tables/logia-workflow-matrix.md` оновлено статус логії 25.
- `06_Reconstructions/earliest-sayings-gospel/inclusion-decisions-table.md` додано рішення для логії 25.
- `06_Reconstructions/earliest-sayings-gospel/evidence-dossier-en.md` додано summary логії 25.
- `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk.md` оновлено до v0.4 і додано логію 25 з маркером.
- `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk-apparatus.md` оновлено до v0.2.
...
- `00_Project/ide-codex-logion-026-speck-beam-deepening-prompt.md` - промпт для поглиблення логії 26.
- `05_Logia_Corpus/cards/logion-026.md` - поглиблена картка логії 26.
- `04_Synoptic_Parallels/logion-026-speck-beam.md` - evidence table для Thomas 26 / P.Oxy. 1 / Matthew 7:3-5 / Luke 6:41-42.
- `06_Reconstructions/earliest-sayings-gospel/notes/logion-026-evidence-en.md` - англомовна evidence note для логії 26.

### Що оновлено

- `05_Logia_Corpus/tables/logia-index.md` додано логію 26.
- `05_Logia_Corpus/tables/logia-workflow-matrix.md` оновлено логію 26.
- `06_Reconstructions/earliest-sayings-gospel/inclusion-decisions-table.md` додано рішення для логії 26.
- `06_Reconstructions/earliest-sayings-gospel/evidence-dossier-en.md` додано summary логії 26.
- `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk.md` оновлено до v0.5 і додано логію 26 з маркером.
- `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk-apparatus.md` оновлено до v0.3.
...
- `00_Project/ide-codex-logion-027-fasting-sabbath-poxy1-poxy5575-prompt.md` - промпт для поглиблення логії 27.
- `04_Synoptic_Parallels/logion-027-fasting-sabbath.md` - evidence table для Thomas 27 / P.Oxy. 1 / P.Oxy. 5575 / fasting і Sabbath controls.
- `06_Reconstructions/earliest-sayings-gospel/notes/logion-027-evidence-en.md` - англомовна evidence note для логії 27.
- `02_Sources_And_Manuscripts/primary_texts/greek_poxy/gospels-net-poxy5575-snapshot.html` - локальний snapshot Gospels.net для P.Oxy. 5575.
- `02_Sources_And_Manuscripts/primary_texts/notes/nasscal-poxy5575-snapshot.html` - локальний snapshot NASSCAL для P.Oxy. 5575.

### Що оновлено

- `05_Logia_Corpus/cards/logion-027.md` оновлено з контрольної картки до поглибленої картки v0.2.
- `05_Logia_Corpus/tables/logia-index.md` додано probability assessment для логії 27.
- `05_Logia_Corpus/tables/logia-workflow-matrix.md` оновлено статус логії 27.
- `06_Reconstructions/earliest-sayings-gospel/inclusion-decisions-table.md` оновлено рішення для логії 27.
- `06_Reconstructions/earliest-sayings-gospel/evidence-dossier-en.md` додано summary логії 27.
- `06_Reconstructions/earliest-sayings-gospel/notes/ritual-ethics-cluster-006-014-027-104-en.md` оновлено статус логії 27 у кластері.
...
- `00_Project/ide-codex-logion-006-ethical-core-parallels-prompt.md` - промпт для тесту етичного ядра логії 6.
- `04_Synoptic_Parallels/logion-006-ethical-core.md` - evidence table для короткого ядра "не брешіть / не робіть того, що ненавидите".

### Що оновлено

- `05_Logia_Corpus/cards/logion-006.md` оновлено до v0.2.
- `06_Reconstructions/earliest-sayings-gospel/notes/logion-006-evidence-en.md` оновлено до v0.2.
- `05_Logia_Corpus/tables/logia-index.md` оновлено статус і ймовірності для логії 6.
- `05_Logia_Corpus/tables/logia-workflow-matrix.md` оновлено рішення для логії 6.
- `06_Reconstructions/earliest-sayings-gospel/inclusion-decisions-table.md` розділено рішення: етичне ядро `INCLUDE_WITH_MARKER`, повна логія `UNCERTAIN`.
- `06_Reconstructions/earliest-sayings-gospel/evidence-dossier-en.md` оновлено до v0.3.
- `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk.md` оновлено до v0.6 і додано коротке ядро логії 6.
- `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk-apparatus.md` оновлено до v0.4.
...
- `00_Project/final-product-specification.md` - додано третю категорію грецького шару: `Greek retroversion, hypothetical`.
- `01_Methodology/logion-rating-rubric.md` - додано правило грецької ретроверсії для коптсько-збережених логій без extant Greek witness.
- `06_Reconstructions/earliest-sayings-gospel/evidence-dossier-en.md` - додано `Greek Retroversion Policy`.
...
- `00_Project/ide-codex-corpus-completion-poxy1-logia-028-033-prompt.md` - промпт для первинного проходу P.Oxy. 1 логій 28-33.
- `05_Logia_Corpus/cards/logion-028.md` - первинна картка: світ, сп'яніння, спрага, сліпота серця.
- `05_Logia_Corpus/cards/logion-029.md` - первинна картка: плоть/дух/тіло, багатство в убогості.
- `05_Logia_Corpus/cards/logion-030.md` - первинна картка: двоє/один, присутність Ісуса, зв'язок із 77b.
- `05_Logia_Corpus/cards/logion-031.md` - первинна картка: пророк у батьківщині, лікар.
- `05_Logia_Corpus/cards/logion-032.md` - первинна картка: місто на високій горі.
- `05_Logia_Corpus/cards/logion-033.md` - первинна картка: почуте на вухо / дахи, лампа.

### Що оновлено

- `05_Logia_Corpus/tables/logia-index.md` - додано логії 28-33.
- `05_Logia_Corpus/tables/logia-workflow-matrix.md` - логії 28-33 переведено з `NOT_STARTED` у первинний корпусний статус.
...
- `00_Project/ide-codex-logia-031-033-high-candidate-deepening-prompt.md` - промпт для поглиблення логій 31-33.
- `04_Synoptic_Parallels/logia-031-033-poxy1-synoptic-controls.md` - спільна таблиця P.Oxy. 1 / синоптичних контролів.
- `06_Reconstructions/earliest-sayings-gospel/notes/logion-031-evidence-en.md` - evidence note для логії 31.
- `06_Reconstructions/earliest-sayings-gospel/notes/logion-032-evidence-en.md` - evidence note для логії 32.
- `06_Reconstructions/earliest-sayings-gospel/notes/logion-033-evidence-en.md` - evidence note для логії 33.

### Що оновлено

- `05_Logia_Corpus/cards/logion-031.md`, `logion-032.md`, `logion-033.md` оновлено до v0.2.
- `05_Logia_Corpus/tables/logia-index.md` і `logia-workflow-matrix.md` синхронізовано.
- `06_Reconstructions/earliest-sayings-gospel/inclusion-decisions-table.md` додано рішення для логій 31-33.
- `06_Reconstructions/earliest-sayings-gospel/evidence-dossier-en.md` оновлено до v0.4.
- `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk.md` оновлено до v0.7 і додано логії 31-33.
- `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk-apparatus.md` оновлено до v0.5.
...
- `00_Project/ide-codex-corpus-completion-poxy655-logia-036-039-prompt.md` - промпт для первинного проходу P.Oxy. 655 блоку 36-39.
- `05_Logia_Corpus/cards/logion-036.md` - первинна картка: не турбуватися про одяг; ширший комплекс їжа/одяг/лілії.
- `05_Logia_Corpus/cards/logion-037.md` - первинна картка: явлення, роздягання без сорому, малі діти, Син Живого.
- `05_Logia_Corpus/cards/logion-038.md` - первинна картка: бажання чути слова; майбутнє шукання Ісуса.
- `05_Logia_Corpus/cards/logion-039.md` - первинна картка: ключі знання; мудрі як змії і чисті як голуби.

### Що оновлено

- `05_Logia_Corpus/tables/logia-index.md` - додано логії 36-39.
- `05_Logia_Corpus/tables/logia-workflow-matrix.md` - логії 36-39 переведено з `NOT_STARTED` у первинний корпусний статус.
...
- `00_Project/ide-codex-logia-036-039-poxy655-high-candidate-deepening-prompt.md` - промпт для поглиблення P.Oxy. 655 high candidates.
- `04_Synoptic_Parallels/logia-036-039-poxy655-synoptic-controls.md` - таблиця Coptic Thomas / P.Oxy. 655 / P.Oxy. 5575 / синоптичних контролів.
- `06_Reconstructions/earliest-sayings-gospel/notes/logion-036-evidence-en.md` - evidence note для логії 36.
- `06_Reconstructions/earliest-sayings-gospel/notes/logion-039-evidence-en.md` - evidence note для логії 39.

### Що оновлено

- `05_Logia_Corpus/cards/logion-036.md` і `logion-039.md` оновлено до v0.2.
- `05_Logia_Corpus/tables/logia-index.md` і `logia-workflow-matrix.md` синхронізовано.
- `06_Reconstructions/earliest-sayings-gospel/inclusion-decisions-table.md` додано рішення для логій 36 і 39.
- `06_Reconstructions/earliest-sayings-gospel/evidence-dossier-en.md` оновлено до v0.5.
- `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk.md` оновлено до v0.8.
- `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk-apparatus.md` оновлено до v0.6.
...
- `00_Project/ide-codex-logia-034-035-bridge-deepening-prompt.md` - промпт для закриття містка 34-35.
- `05_Logia_Corpus/cards/logion-034.md` - поглиблена картка: сліпий веде сліпого.
- `05_Logia_Corpus/cards/logion-035.md` - поглиблена картка: дім сильного, зв'язати і пограбувати.
- `04_Synoptic_Parallels/logia-034-035-bridge-synoptic-controls.md` - синоптичні контролі для 34-35.
- `06_Reconstructions/earliest-sayings-gospel/notes/logion-034-evidence-en.md` - evidence note для логії 34.
- `06_Reconstructions/earliest-sayings-gospel/notes/logion-035-evidence-en.md` - evidence note для логії 35.

### Що оновлено

- `05_Logia_Corpus/tables/logia-index.md` і `logia-workflow-matrix.md` синхронізовано.
- `06_Reconstructions/earliest-sayings-gospel/inclusion-decisions-table.md` додано рішення для логій 34-35.
- `06_Reconstructions/earliest-sayings-gospel/evidence-dossier-en.md` оновлено до v0.6.
- `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk.md` оновлено до v0.9.
- `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk-apparatus.md` оновлено до v0.7.
...
- `00_Project/ide-codex-high-candidate-logia-008-020-022-prompt.md` - промпт для high-candidate review.
- `04_Synoptic_Parallels/logia-008-020-022-high-candidate-controls.md` - таблиця контролів для логій 8, 20 і 22.
- `06_Reconstructions/earliest-sayings-gospel/notes/logion-008-evidence-en.md` - evidence note для логії 8.

### Що оновлено

- `05_Logia_Corpus/cards/logion-008.md` оновлено до v0.2 і переведено в `UNCERTAIN`.
- `05_Logia_Corpus/cards/logion-020.md` оновлено до v0.4 і переведено в `INCLUDE_WITH_MARKER`.
- `05_Logia_Corpus/cards/logion-022.md` оновлено до v0.3: дитяче ядро `INCLUDE_WITH_MARKER`, повна логія `UNCERTAIN`.
- `06_Reconstructions/earliest-sayings-gospel/notes/logion-020-evidence-en.md` оновлено до v0.3.
- `06_Reconstructions/earliest-sayings-gospel/notes/logion-022-evidence-en.md` оновлено до v0.2.
- `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk.md` оновлено до v1.0.
- `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk-apparatus.md` оновлено до v0.8.
- `06_Reconstructions/earliest-sayings-gospel/evidence-dossier-en.md` оновлено до v0.7.
...
- `00_Project/ide-codex-logion-016-division-core-finalization-prompt.md` - промпт для фіналізації ядра логії 16.
- `04_Synoptic_Parallels/logion-016-division-core-final-controls.md` - таблиця остаточного розділення шарів логії 16.

### Що оновлено

- `05_Logia_Corpus/cards/logion-016.md` оновлено до v0.3.
- `06_Reconstructions/earliest-sayings-gospel/notes/logion-016-evidence-en.md` оновлено до v0.2.
- `05_Logia_Corpus/tables/logia-index.md` і `logia-workflow-matrix.md` синхронізовано.
- `06_Reconstructions/earliest-sayings-gospel/inclusion-decisions-table.md` оновлено рішення для логії 16.
- `06_Reconstructions/earliest-sayings-gospel/evidence-dossier-en.md` оновлено до v0.8.
- `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk.md` оновлено до v1.1.
- `06_Reconstructions/earliest-sayings-gospel/reconstructed-gospel-uk-apparatus.md` оновлено до v0.9.
