...
1. Виконувати наступні задачі через `project/open-task-prompt-queue-2026-07-18.md`; поточний `NEXT` - release-candidate proof package audit.
...
3. Провести повний page-by-page visual QA українського й англійського PDF та digital companion.
4. Після цього вирішити, чи поточний ReportLab renderer достатній для першого публічного proof, чи треба перейти на сильніший typesetting pipeline.
