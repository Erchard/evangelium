...
- Full book assembly and typesetting pipeline v0.1 виконано: створено повний український paper-book source і 118-сторінковий Ukrainian full book proof із clean text first та повним 114-логійним додатком; англійський proof зібрано чесно як clean text + evidence dossier, бо повний англійський appendix ще відсутній.
...
1. Виконувати наступні задачі через `project/open-task-prompt-queue-2026-07-18.md`; поточний `NEXT` - final production typesetting and copyedit gate.
...
3. Вирішити production-grade typesetting path: залишити ReportLab як фінал, перейти на Typst/LaTeX або підготувати професійний typesetting handoff.
4. Провести фінальну copyedit/proof gate-перевірку української книги, англійської книги й digital companion.
