...
1. Виконувати наступні задачі через `project/open-task-prompt-queue-2026-07-18.md`; поточний `NEXT` - render pipeline and first proofs.
...
3. Згенерувати перші proof artifacts або мінімальний repeatable renderer scaffold.
4. Після цього виконати visual/text proof-QA і фінальне PDF/e-book proofing.
