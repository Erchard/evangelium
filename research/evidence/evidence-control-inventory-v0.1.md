...
| Logia with cluster/range control file | 23 |
| Logia with cluster/context note but no direct evidence note | 7 |
| Matrix YES but no actual direct evidence note found | 0 |
| Matrix NO but actual direct evidence note found | 0 |
| Logia with neither evidence note nor control/cluster support | 22 |
...
| `P2` | 21 | Low-priority appendix/no-note rationale needed after Logion 80 gained cluster-control support. |
...
Interpretation: the workflow matrix is aligned for the first P1 package and Package A. Logion 23 now has a dedicated `logion-023-evidence-en.md` file in addition to the Thomas unity / monachos cluster note. Logion 80 now has living/dead/world cluster-control support, but still no direct evidence note. Logia 54, 58, 68, and 69 now have beatitudes cluster-control support. Logia 2, 92, and 94 now have seek/find cluster-control support. Direct evidence-note coverage is unchanged. Remaining work is therefore no longer all-114 evidence-gap closure; the next quality work is additional cluster-control notes, P2 appendix rationales, and explicit exclusion rationale for Logion 114.
...
| 2 | YES | `reconstruction/earliest-sayings-gospel/notes/logion-002-evidence-en.md` | `controls/synoptic-parallels/logion-002-matthew-luke.md`<br>`reconstruction/earliest-sayings-gospel/notes/seek-find-cluster-control-en.md` | YES | INCLUDE_WITH_MARKER | P.Oxy. 654 | `OK` | Use seek/find cluster-control note in appendix/dossier; keep reader inclusion marked. |
...
| 10 | YES | `reconstruction/earliest-sayings-gospel/notes/logion-010-evidence-en.md` | `controls/synoptic-parallels/logion-010-fire-luke-control.md`<br>`reconstruction/earliest-sayings-gospel/notes/fire-kingdom-cluster-control-en.md` | YES | fire-casting core INCLUDE_WITH_MARKER; full logion UNCERTAIN | Greek retroversion, hypothetical | `OK` | Use fire/kingdom cluster-control note; keep short fire-casting core in reader and watching/blazing continuation in apparatus. |
| 11 | YES | `reconstruction/earliest-sayings-gospel/notes/logion-011-evidence-en.md` | `controls/synoptic-parallels/logion-011-heaven-passing-controls.md`<br>`reconstruction/earliest-sayings-gospel/notes/thomas-unity-monachos-cluster-en.md`<br>`reconstruction/earliest-sayings-gospel/notes/living-dead-world-cluster-control-en.md` | NO | UNCERTAIN | Greek retroversion, hypothetical | `OK` | Use living/dead/world cluster-control note in appendix/dossier; no reader promotion. |
...
| 18 | YES | `reconstruction/earliest-sayings-gospel/notes/logion-018-evidence-en.md` | `reconstruction/earliest-sayings-gospel/notes/living-dead-world-cluster-control-en.md` | NO | UNCERTAIN | No loaded P.Oxy. witness | covered v0.1 | Use evidence rationale plus living/dead/world cluster-control note in appendix/dossier; no reader promotion. |
...
| 52 | YES | `reconstruction/earliest-sayings-gospel/notes/logion-052-evidence-en.md` | `reconstruction/earliest-sayings-gospel/notes/living-dead-world-cluster-control-en.md` | NO | UNCERTAIN | No loaded P.Oxy. witness | covered v0.1 | Use evidence rationale plus living/dead/world cluster-control note in appendix/dossier; no reader promotion. |
| 53 | NO | — | — | NO | DEFER | No loaded P.Oxy. witness | `P2` | Provide short appendix rationale / no-note rationale. |
| 54 | YES | `reconstruction/earliest-sayings-gospel/notes/logion-054-evidence-en.md` | `controls/synoptic-parallels/logion-054-blessed-poor-controls.md`<br>`reconstruction/earliest-sayings-gospel/notes/beatitudes-cluster-control-en.md` | YES | INCLUDE_WITH_MARKER | No loaded P.Oxy. witness | `OK` | Use beatitudes cluster-control note in appendix/dossier; keep reader inclusion marked. |
| 55 | YES | `reconstruction/earliest-sayings-gospel/notes/logion-055-evidence-en.md` | `controls/synoptic-parallels/logion-055-discipleship-cross-controls.md`<br>`reconstruction/earliest-sayings-gospel/notes/family-renunciation-cluster-control-en.md` | NO | UNCERTAIN | No loaded P.Oxy. witness | `OK` | Use family-renunciation cluster-control note; keep appendix-only because cross-bearing/worthiness language requires caution. |
| 56 | YES | `reconstruction/earliest-sayings-gospel/notes/logion-056-evidence-en.md` | `reconstruction/earliest-sayings-gospel/notes/living-dead-world-cluster-control-en.md` | NO | UNCERTAIN | No loaded P.Oxy. witness | covered v0.1 | Use evidence rationale plus living/dead/world cluster-control note in appendix/dossier; no reader promotion. |
...
| 58 | YES | `reconstruction/earliest-sayings-gospel/notes/logion-058-evidence-en.md` | `reconstruction/earliest-sayings-gospel/notes/beatitudes-cluster-control-en.md` | NO | UNCERTAIN | No loaded P.Oxy. witness | covered v0.1 | Use evidence rationale plus beatitudes cluster-control note in appendix/dossier; no reader promotion. |
| 59 | YES | `reconstruction/earliest-sayings-gospel/notes/logion-059-evidence-en.md` | `reconstruction/earliest-sayings-gospel/notes/living-dead-world-cluster-control-en.md` | NO | UNCERTAIN | No loaded P.Oxy. witness | covered v0.1 | Use evidence rationale plus living/dead/world cluster-control note in appendix/dossier; no reader promotion. |
| 60 | YES | `reconstruction/earliest-sayings-gospel/notes/logion-060-evidence-en.md` | `reconstruction/earliest-sayings-gospel/notes/living-dead-world-cluster-control-en.md` | NO | UNCERTAIN | No loaded P.Oxy. witness | covered v0.1 | Use evidence rationale plus living/dead/world cluster-control note in appendix/dossier; no reader promotion. |
...
| 68 | YES | `reconstruction/earliest-sayings-gospel/notes/logion-068-evidence-en.md` | `reconstruction/earliest-sayings-gospel/notes/beatitudes-cluster-control-en.md` | NO | UNCERTAIN | No loaded P.Oxy. witness | covered v0.1 | Use evidence rationale plus beatitudes cluster-control note in appendix/dossier; no reader promotion. |
| 69 | YES | `reconstruction/earliest-sayings-gospel/notes/logion-069-evidence-en.md` | `reconstruction/earliest-sayings-gospel/notes/beatitudes-cluster-control-en.md` | NO | UNCERTAIN | No loaded P.Oxy. witness | covered v0.1 | Use evidence rationale plus beatitudes cluster-control note in appendix/dossier; no reader promotion. |
...
| 80 | NO | — | `reconstruction/earliest-sayings-gospel/notes/living-dead-world-cluster-control-en.md` | NO | DEFER | No loaded P.Oxy. witness | `cluster-supported` | Use living/dead/world cluster-control note in appendix/dossier; still no direct evidence note. |
...
| 82 | YES | `reconstruction/earliest-sayings-gospel/notes/logion-082-evidence-en.md` | `reconstruction/earliest-sayings-gospel/notes/fire-kingdom-cluster-control-en.md` | NO | APPENDIX_ONLY_UNCERTAIN | No loaded P.Oxy. witness | covered v0.1 | Use fire/kingdom cluster-control note; keep appendix-only because support is mostly internal/thematic rather than direct external control. |
...
| 92 | YES | `reconstruction/earliest-sayings-gospel/notes/logion-092-evidence-en.md` | `reconstruction/earliest-sayings-gospel/notes/seek-find-cluster-control-en.md` | NO | UNCERTAIN | Greek retroversion, hypothetical | covered v0.1 | Use evidence rationale plus seek/find cluster-control note in appendix/dossier; no reader promotion. |
...
| 94 | YES | `reconstruction/earliest-sayings-gospel/notes/logion-094-evidence-en.md` | `controls/synoptic-parallels/logion-094-seek-knock-controls.md`<br>`reconstruction/earliest-sayings-gospel/notes/seek-find-cluster-control-en.md` | NO | KEEP_APPENDIX_ONLY_FOR_NOW | Greek retroversion, hypothetical | `OK` | Use seek/find cluster-control note in appendix/dossier; keep appendix-only unless future reader economy changes. |
...
| 101 | YES | `reconstruction/earliest-sayings-gospel/notes/logion-101-evidence-en.md` | `reconstruction/earliest-sayings-gospel/notes/family-renunciation-cluster-control-en.md` | NO | UNCERTAIN | Greek retroversion, hypothetical | covered v0.1 | Use family-renunciation cluster-control note; keep appendix-only and treat possible family-renunciation core as split-core apparatus material. |
...
| 111 | YES | `reconstruction/earliest-sayings-gospel/notes/logion-111-evidence-en.md` | `reconstruction/earliest-sayings-gospel/notes/living-dead-world-cluster-control-en.md` | NO | UNCERTAIN | Greek retroversion, hypothetical | covered v0.1 | Use evidence rationale plus living/dead/world cluster-control note in appendix/dossier; no reader promotion. |
...
Superseded next-step note, 2026-07-18: Phase 4, the Phase 5 P1 evidence-rationale packages, living/dead/world cluster-control, beatitudes cluster-control, seek/find cluster-control, family-renunciation cluster-control, and fire/kingdom cluster-control have been completed. Continue with the wealth/renunciation cluster-control note and the remaining explicit exclusion rationale for Logion 114.
