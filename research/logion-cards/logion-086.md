...
Коротке ядро вже входить до clean reader з маркером. Синоптичний контроль у Мт 8:20 і Лк 9:58 сильний, але напрям залежності й відсутність extant Greek Thomas witness лишаються предметом апарату.
...
Для реконструкції ця логія важлива як марковане clean-reader ядро. Вона друкується в чистому тексті, а повний додаток має пояснити залежність від Мт 8:20 / Лк 9:58, відсутність extant Greek Thomas witness і межі грецької ретроверсії. Робоче рішення картки: `INCLUDE_WITH_MARKER`; позначка для чистого читача: YES; попередньо визначений шар: лисиці, птахи і Син людини без місця.
...
Наступна дія: publication polish; keep Greek retroversion hypothetical and refine dossier bibliography.
...
- Включене раннє ядро: foxes/birds/Son-of-Man homelessness core, printed with marker.
- Вторинні / томині ризики: foxes/birds/Son-of-Man core is controlled, but Thomas wording and homelessness framing must remain marked against Matt/Luke dependence.
- Грецька політика: Грецький шар можна використовувати тільки як `Greek retroversion, hypothetical`, не як рукописний свідок.

### Наступна дія

Publication polish: keep Greek retroversion hypothetical; refine dossier bibliography and dependence warning.
...
- Next action: Publication polish: keep Greek retroversion hypothetical; refine dossier bibliography.
