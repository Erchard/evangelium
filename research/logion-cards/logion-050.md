...
- Evidence note:
  - `reconstruction/earliest-sayings-gospel/notes/logion-050-evidence-en.md`
- Synoptic/control files:
  - NO_DIRECT_CONTROL_RATIONALE: No direct external control is attached; light/origin/sign language remains a Thomasine catechetical exchange until an image-light cluster is written.
...
- Можливе раннє ядро: light/origin response formula; full catechetical exchange about signs, movement and rest remains too Thomasine and cluster-dependent for clean-reader inclusion.
- Вторинні / томині ризики: light, origin, movement/rest and sign-of-Father language form a catechetical Thomasine exchange, not a securely separable early saying. наявні мотиви, які можуть належати до томиного богословського розгортання.
