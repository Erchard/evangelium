...
| `full-logion-commentary-appendix-uk.md` | Ukrainian full 114-logion commentary appendix: all 114 logia have reader-facing explanation; Logia 1-80 are editorially consolidated, while Logia 81-114 still need consolidation of card-derived interpretation blocks. |
...
- English, Coptic, Greek, Arabic literary, and parallel layers are synchronized for the current 37-unit reader.
...
- `full-logion-commentary-appendix-uk.md` covers all 114 logia with reader-facing explanation. Logia 1-80 are now consolidated entries; Logia 81-114 still need the same editorial consolidation.
...
- Editorial consolidation has started: Logia 1-80 are now consolidated appendix entries without duplicated card-derived blocks.
