...
| `full-logion-commentary-appendix-uk.md` | Ukrainian full 114-logion commentary appendix: all 114 logia have reader-facing explanation; Logia 1-60 are editorially consolidated, while Logia 61-114 still need consolidation of card-derived interpretation blocks. |
...
- `full-logion-commentary-appendix-uk.md` covers all 114 logia with reader-facing explanation. Logia 1-60 are now consolidated entries; Logia 61-114 still need the same editorial consolidation.
...
- Editorial consolidation has started: Logia 1-60 are now consolidated appendix entries without duplicated card-derived blocks.
