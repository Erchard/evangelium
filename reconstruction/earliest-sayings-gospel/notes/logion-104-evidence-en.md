...
> Prayer, fasting, and the bridegroom leaving the bridal chamber.

## Textual Witnesses

- Coptic base: extant NHC II,2; primary preserved Thomas witness.
- P.Oxy. 1: not preserved.
- P.Oxy. 654: not preserved.
- P.Oxy. 655: not preserved.
- Greek Thomas layer: hypothetical retroversion only.
- Canonical controls: Mark 2:18-20, Matthew 9:14-15, and Luke 5:33-35.
- Cluster control: `ritual-ethics-cluster-006-014-027-104-en.md`.
