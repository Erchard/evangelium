...
| 12 | YES | NO | `DEFER` | NO | No loaded P.Oxy. witness | Primary card v0.1 | Keep as James/community succession layer. |
| 13 | YES | NO | `DEFER` | NO | No loaded P.Oxy. witness | Primary card v0.1 | Keep as Thomas authority and collection-frame material. |
...
| 15 | YES | NO | `DEFER` | NO | No loaded P.Oxy. witness | Primary card v0.1 | Study born-not-of-woman / Father cluster. |
...
| 19 | YES | NO | `DEFER` | NO | No loaded P.Oxy. witness | Primary card v0.1 | Split into sub-units; study five trees of paradise. |
...
| 70 | YES | NO | `DEFER` | NO | No loaded P.Oxy. witness | Primary card v0.1 | Study inner salvation cluster with 3, 5, and 67. |
| 71 | YES | NO | `DEFER` | NO | No loaded P.Oxy. witness | Primary card v0.1 | Study temple/body/house destruction traditions. |
...
| 80 | YES | NO | `DEFER` | NO | No loaded P.Oxy. witness | Cluster-control v0.1 | Living/dead/world cluster support exists; still no direct evidence note, so keep appendix-only and do not count as evidence-note coverage. |
| 81 | YES | YES | `UNCERTAIN` | NO | No loaded P.Oxy. witness | Evidence rationale v0.1 | Use evidence rationale in appendix; study wealth/power/renunciation cluster. |
