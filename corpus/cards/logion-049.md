...
Для реконструкції ця логія важлива як appendix-only матеріал: вона допомагає читачеві зрозуміти межі корпусу, навіть якщо її не можна чесно друкувати як частину найдавнішого тексту. Робоче рішення картки: UNCERTAIN; позначка для чистого читача: NO; попередньо визначений шар: блаженні самітні й обрані.
...
- Evidence note:
  - `reconstruction/earliest-sayings-gospel/notes/logion-049-evidence-en.md`
- Synoptic/control files:
  - `reconstruction/earliest-sayings-gospel/notes/thomas-unity-monachos-cluster-en.md`
  - MERGE_WITH_EXISTING_CLUSTER: Solitary/elect language belongs under the Thomas unity/monachos cluster rather than a standalone synoptic file.
- Cluster/context notes:
  - `reconstruction/earliest-sayings-gospel/notes/thomas-unity-monachos-cluster-en.md`

### Шарова модель для реконструкції

- Можливе раннє ядро: blessing of the solitary/elect as a unity/monachos motif; not a clean-reader unit without independent control beyond Thomasine internal vocabulary.
- Вторинні / томині ризики: solitary/elect blessing depends heavily on Thomasine monachos vocabulary and lacks enough external control for clean-reader status. наявні мотиви, які можуть належати до томиного богословського розгортання.
...
Synoptic/control files:
- Cluster-control support: `reconstruction/earliest-sayings-gospel/notes/thomas-unity-monachos-cluster-en.md`
...
- Next action: Keep in unity/monachos cluster.
