...
Статус: normalized corpus card; current workflow status: `Multilingual sync v0.1`.
...
- Можливе раннє ядро: harvest/laborers aphorism; коротка місійна формула може стояти в ранньому шарі, але потребує маркера через синоптичний і церковно-місійний контроль.
- Вторинні / томині ризики: harvest/laborers saying is controlled, but mission-context dependence and wording variants still require marked treatment.
