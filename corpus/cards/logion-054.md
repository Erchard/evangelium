...
- Можливе раннє ядро: poor/kingdom beatitude; кандидат на ранній beatitude-core, але друкувати з маркером через потребу зіставлення з луканською й матеєвою формами.
- Вторинні / томині ризики: poor/kingdom beatitude is strong, but Matthew/Luke wording variants and Thomas form require the marker to remain visible.
...
- Next action: Use beatitudes cluster-control v0.1 in appendix/dossier; keep Logion 54 in clean reader with marker and do not silently harmonize Matthew/Luke/Thomas wording.
