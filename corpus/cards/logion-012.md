...
Наступна дія: залишити поза clean reader; окремо дослідити Якова Праведного і ранню єрусалимську традицію як community-succession cluster перед фінальною appendix-редакцією.
...
- Evidence note:
  - `reconstruction/earliest-sayings-gospel/notes/logion-012-evidence-en.md`
...
- Можливе раннє ядро: не використовується як самостійний ранній вислів, бо ядро стосується Якова Праведного й наступництва громади; потребує окремого succession/community-control dossier.
