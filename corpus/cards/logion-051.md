...
- Synoptic/control files:
  - NO_DIRECT_CONTROL_RATIONALE: No direct external control is attached; realized rest/new-world language should be discussed through Logia 3 and 113 rather than treated as controlled independently.
...
- Можливе раннє ядро: realized-eschatology saying that rest and the new world have already come; must be tested with Logia 3 and 113 before separation from Thomasine dialogue frame.
- Вторинні / томині ризики: realized rest/new-world language may be Thomasine dialogue framing and overlaps with stronger kingdom-present material in Logia 3 and 113.
...
- Next action: Study realized eschatology with Thomas 3 and 113.
