...
Lost-sheep core вже входить до clean reader з маркером. Томина особливість - "найбільша" вівця і любов більше за дев'яносто дев'ять - лишається в апараті як можливий редакційний наголос.
...
Для реконструкції ця логія важлива як частково включений матеріал. Clean reader друкує lost-sheep search core; "largest sheep" and "I love you more" залишаються в апараті. Робоче рішення картки: `INCLUDE_WITH_MARKER` for lost-sheep core; full logion `UNCERTAIN`; позначка для чистого читача: YES; попередньо визначений шар: притча про загублену вівцю.
...
Наступна дія: publication polish; largest/love-more ending remains apparatus material.
...
- Включене раннє ядро: lost-sheep search core, printed with marker.
- Вторинні / томині ризики: lost-sheep search core is controlled, but largest-sheep and love-more-than-ninety-nine ending look like Thomasine emphasis.
- Грецька політика: Грецький шар можна використовувати тільки як `Greek retroversion, hypothetical`, не як рукописний свідок.

### Наступна дія

Publication polish: keep largest/love-more ending in apparatus and preserve dependence warning.
...
- Current decision: `INCLUDE_WITH_MARKER` for lost-sheep core; full logion `UNCERTAIN`.
- Reader text: YES.
- Greek witness status: Greek retroversion, hypothetical.
...
- Next action: Publication polish: largest/love-more ending remains apparatus material.
