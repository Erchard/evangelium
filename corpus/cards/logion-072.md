...
Сильний кандидат через близьку паралель у Луки. Проте треба перевірити, чи форма Фоми є коротшим незалежним варіантом, чи залежить від Луки, чи обидва тексти працюють із давнішою спільною традицією.
...
- Можливе раннє ядро: refusal-to-arbitrate-inheritance saying; потенційно ранній незалежний соціально-етичний вислів, але має бути маркований через близькість до луканського епізоду.
- Вторинні / томині ризики: inheritance-dispute refusal is controlled, but clean reader must not import the whole Lukan narrative setting or legal frame.
...
- Next action: English/Coptic/Greek retroversion/parallel rows added; Luke-dependence warning retained.
