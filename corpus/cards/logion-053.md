...
- Evidence note:
  - `reconstruction/earliest-sayings-gospel/notes/logion-053-evidence-en.md`
- Synoptic/control files:
  - NO_DIRECT_CONTROL_RATIONALE: No direct synoptic control is attached; circumcision/flesh-spirit remains community-halakhic reflection, not controlled sayings material.
...
- Можливе раннє ядро: circumcision/flesh-spirit material не друкується як раннє ядро, бо головний шар є галахічно-богословською полемікою, а не стабільною короткою притчею чи афоризмом.
- Вторинні / томині ризики: circumcision of flesh/spirit reads as community halakhic-theological argument rather than a securely recoverable earliest gospel saying.
