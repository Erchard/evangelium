...
Для реконструкції ця логія важлива як appendix-only матеріал: вона допомагає читачеві зрозуміти межі корпусу, навіть якщо її не можна чесно друкувати як частину найдавнішого тексту. Робоче рішення картки: UNCERTAIN; позначка для чистого читача: NO; попередньо визначений шар: пророки, живий і мертві.
...
- Synoptic/control files:
  ...
  - MERGE_WITH_EXISTING_CLUSTER: Living One versus dead prophets belongs under the living/dead/world cluster.
- Cluster/context notes:
  - `reconstruction/earliest-sayings-gospel/notes/living-dead-world-cluster-control-en.md`

### Шарова модель для реконструкції

- Можливе раннє ядро: contrast between prophets/dead witnesses and the living one; current form remains appendix-only because it is dialogical and polemical.
- Вторинні / томині ризики: prophets/dead/living contrast is polemical and dialogical, making it hard to isolate an independent early saying.
...
Use living/dead/world cluster-control v0.1; keep appendix-only as a Living One / dead-prophets interpretive frame.
...
- Next action: Use living/dead/world cluster-control v0.1; keep appendix-only as a Living One / dead-prophets interpretive frame.
