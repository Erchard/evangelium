...
If you have money, do not lend at interest; rather, give it to someone from whom you will not receive it back.

## Попередні паралелі

| Джерело | Місце | Нотатка |
| --- | --- | --- |
| Лука | 6:34-35 | Давати/позичати без очікування повернення; important control. |
| Второзаконня | 23:19-20 | Заборона лихви як юдейський етичний фон. |
...
- Next action: Publication polish: clarify damaged opening and anti-usury controls.
