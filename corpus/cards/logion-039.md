...
Історична локальна ймовірність для ключ/знання ядра:
...
Історична локальна ймовірність для змії/голуби ядра:
...
- Можливе раннє ядро: два марковані ядра - keys-of-knowledge polemic і serpents/doves wisdom charge; не друкувати як одну гладку композицію без пояснення зрощення.
- Вторинні / томині ризики: keys-of-knowledge and serpents/doves are two controlled subunits; treating them as one unmarked original composition would overstate the evidence.
