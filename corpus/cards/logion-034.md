...
- Можливе раннє ядро: blind-leading-blind proverb; коротка прислів'єва форма має добрий ранній потенціал, але потребує маркера через сильну синоптичну контрольованість.
- Вторинні / томині ризики: blind-leading-blind has strong control, but wording and placement still require dependence review before removing the marker.
