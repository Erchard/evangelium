...
Наступна дія: залишити поза clean reader; користуватися evidence note для P.Oxy. 655 і Thomas 24(?), чітко відокремлюючи коптський світловий вислів від грецького фрагмента про явлення/роздягання.

## Читацьке тлумачення

### Простий сенс

У простому сенсі логія працює з темами прихованого, явного, світла, бачення або відкриття. Вона говорить, що істина не завжди лежить на поверхні, але й не є недоступною: її треба побачити, відкрити або впізнати. У робочому українському перекладі це звучить так: "Учні сказали: покажи нам місце, де ти є, бо ми повинні його шукати. Він відповів: у людині світла є світло; воно освітлює весь світ. Якщо воно не світить, настає темрява."
...
- Можливе раннє ядро: light/person/location saying відкладається, доки не буде розділено коптську форму, можливий грецький контроль P.Oxy. 655 і пізнішу герменевтичну рамку.
- Вторинні / томині ризики: Coptic light-person saying and possible P.Oxy. 655 material do not align cleanly; the light anthropology may be a developed Thomasine layer.
...
Use evidence rationale v0.1; keep P.Oxy. 655 / Thomas 24(?) uncertainty explicit.
...
- Next action: Use evidence rationale v0.1; keep P.Oxy. 655 / Thomas 24(?) uncertainty explicit.
