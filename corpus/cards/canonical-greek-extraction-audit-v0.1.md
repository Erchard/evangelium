...
Postscript: pending P.Oxy. XML extraction gap закрито в `corpus/cards/poxy-xml-extraction-audit-v0.1.md`.

Тепер головний наступний крок - documentation sync pass, а після нього true all-114 publication decision table.
