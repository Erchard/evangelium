...
Для реконструкції ця логія важлива як appendix-only матеріал: вона допомагає читачеві зрозуміти межі корпусу, навіть якщо її не можна чесно друкувати як частину найдавнішого тексту. Робоче рішення картки: UNCERTAIN; позначка для чистого читача: NO; попередньо визначений шар: двоє в мирі; гора зрушиться.
...
- Synoptic/control files:
  - CREATE_CONTROL_FILE: Create an agreement/prayer/mountain-moving control with Matthew 18:19-20 and Logion 106; interim cluster context is Thomas unity language.
- Cluster/context notes:
  - `reconstruction/earliest-sayings-gospel/notes/thomas-unity-monachos-cluster-en.md`

### Шарова модель для реконструкції

- Можливе раннє ядро: agreement/prayer saying about two being at peace and moving a mountain; evaluate with Logion 106 and Matt 18:19-20 before any reader promotion.
- Вторинні / томині ризики: agreement, peace, prayer and mountain-moving motifs may combine Matt 18:19-20 with other tradition rather than preserve one clean core.
