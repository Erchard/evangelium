...
- Можливе раннє ядро: having/receiving-and-loss aphorism; коротка парадоксальна форма може бути ранньою, але потребує маркера через близькість до ширшого канонічного мотиву.
- Вторинні / томині ризики: having/receiving formula is controlled, but Thomas placement may shift the saying toward collection-internal wisdom rather than its earlier context.
